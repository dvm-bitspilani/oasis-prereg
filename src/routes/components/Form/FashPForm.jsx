...
const FashPForm = () => {
  ...
  const handleSubmit = (e) => {
    ...
    const sendRegisteredDataToBackend = () => {
      const postLink = "https://prereg.bits-oasis.org/main/FashPRegistration/";
      let config = {
        headers: {
      ...
      >
        <div className="form-wrapper">
          <div className="form-container">
            <div className="form-heading">Register for Fash P</div>
            <form action="" className="main-form">
              ...
              {localStorage.getItem("fashp_registered") === "true" && (
